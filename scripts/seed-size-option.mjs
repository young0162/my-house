...
const SIZE_OPTION_SEED_DOC = "docs/db_seed/option/2026-06-22_size_option_seed_plan.md";
...
const parseSizeOptionSeed = (filePath) => {
...
try {
  const seed = parseSizeOptionSeed(SIZE_OPTION_SEED_DOC);
  const before = {
